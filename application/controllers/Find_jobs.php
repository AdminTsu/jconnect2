...
var $userid;
    ...
    function index() {
        ...
        if($url == '/find_jobs' || $url == '/Find_jobs'){
            ...
            $from = isset($matches[0][0]) ? $matches[0][0] : 1;
        }
        $limit       = 10;
    ...
    function search() {
        ...
        // $keywrd = $this->input->post('keywrd');
        // $lokasi = $this->input->post('lokasi');
        // $spsliz = $this->input->post('spsliz');
        // $jobpos = $this->input->post('jobpos');
        // $typjob = $this->input->post('typjob');
    ...
    function Find_Jobs_detail($idjob)
    {
        ...
        $findJob = $this->m_job->getJobUpdate_Detail($idjob);
        if (empty($findJob)) {
            show_404();
        }
