...
var $userid;
    ...
    //     $RangeDate = '
    //         <input class="form-control" name="txtDATMSK" id="txtDATMSK" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = \'Tgl Masuk\'" placeholder="Tgl Masuk" style="width: 110px;text-align: left;">
    //     ';
    //     $callback = array('RangeDate'=>$RangeDate);
    //     echo json_encode($callback);
    // }
    ...
    function profile_simpan($id){
        ...
        $this->crud->save($input, array('PKR_IDENTS'=> $id));
        $this->crud->unsetMe();
