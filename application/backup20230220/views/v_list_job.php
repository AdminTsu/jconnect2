...
$iduser = $this->session->userdata('USR_IDENTS');    
    ...
    // foreach($arrJOBS as $row){
        ...
        $bidang = isset($row->JOB_ASPECS) ? $row->JOB_ASPECS : 'belum diisi';
        $lokasi = isset($row->JOB_LCTION) ? $row->JOB_LCTION : 'belum diisi';
        ...
        <div class="single-job-items mb-10" id="joblist">
            <div class="job-items">
                ...
                <div class="job-tittle">
                    ...
                    <ul>
                        <li style="width: 300px;"><i class="fa fa-building"></i><?=$comnam?></li>
                        <li style="width: 250px;"><i class="fa fa-briefcase"></i><?=$bidang?></li>
                    </ul>
                    <ul>
                        <li style="width: 300px;"></i>IDR <?=number_format($salmin,0)?> - Rp. <?=number_format($salmax,0)?></li>
                        <li style="width: 250px;"><i class="fas fa-map-marker-alt"></i> <?=$lokasi?></li>
                    </ul>
                    <ul>
                        <li><i class="fa fa-flag"></i><span><b>Diiklankan </b> <?=$durasi?></span></li>
                    </ul>
                </div>
            </div>
            <div class="job-tittle">
