    ...
    <div class= row id="login">
      <form class="login" role="form" id=formgw method=post action="/login/validate_credentials">
        <fieldset class="clearfix">
          ...
          <p><font size=2 style="color:#cccccc">Melakukan Login ini berarti Anda membaca dan menyetujui <a href="<?=base_url()?>TermOfUse" target='_blank' class="termofuse">Kebijakan Penggunaan</a> dan <a href="<?=base_url()?>privacy" target='_blank' class="privacy">Kebijakan Privasi</a> kami.</font></p>
          <!-- <br> -->
          <p><input type="submit" value="Masuk"></p>
          <p><font size=3 ><a href="<?=base_url()?>" class="goto">Go To JConnect.co.id</a></font></p>
        </fieldset>
      </form>
