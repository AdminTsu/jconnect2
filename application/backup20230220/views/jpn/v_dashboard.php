...
<html class="no-js" lang="zxx">
    <head>
        ...
        <meta name="description" content="JConncetは、協力関係にあるインドネシアの日系企業と、日本でのスキル・資格・経験を持つ候補者をつなぐ、ジョブポータル形式のオンラインサービスです">
        ...
        <meta name="keywords" content="jconnect.co.id,jconnect-official,indonesia,仕事、求人、日本、インターン、労働者、グリコ、資格、欠員、仕事、キャリア">
                    ...
                    <div class="row align-items-center">
                      ...
                      <?php } ?>
                        ...
                        <div class="col-lg-1 col-md-1">
                            <!-- Logo -->
                            <div class="logo">
                                <a href="<?=base_url()?>jpn"><img src="<?=base_url()?>resources/assets/img/logo/Logo_jconnect_new.png" style='width: 100px;height:30px;padding-left: 30px;' alt=""></a>
                            </div>  
                        </div>
                        <!-- --------------------------------------- Website Menu ------------------------------------- -->
            ...
            <div class="container">
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-5">
                  <div class="footer-tittle-bottom">
                       ...
                       <span><a href="https://api.whatsapp.com/send?phone=6281312345358&text=こんにちは,%20おめでとうございます%20正午%20夫妻%20管理者%20JConnect" target='_blank' alt='Jika butuh bantuan bisa hubungi kami di Whatsapp ini'><i class="fab fa-whatsapp"></i></a></span>
                     ...
                     <div class="row d-flex center-content-between align-items-center">
                         <div class="col-xl-10 col-lg-10 ">
                             <div class="footer-copy-right">
                                 <p>Copyright &copy;2022 All rights reserved by <a href="<?=base_url()?>">JConnect</a> - Ver. 1.2.0</p>
                             </div>
                         </div>
                     </div>
                </div>
