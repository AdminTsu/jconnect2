...
<div class="row">
    ...
    <div class="col-lg-12">
        <form class="form-contact contact_form" action="/jpn/login_web/validate_credentials" method="post" id="contactForm" novalidate="novalidate" enctype="multipart/form-data">
            ...
            <div class="col-12">
                <center><input type="checkbox" name="chkPrivacy" id="chkPrivacy" value"setuju" onchange="jvChangePrivacy()"> <font size=2 style="color:#cccccc">このフィールドにチェックを入れることで、お客様は以下を読み、同意したことになります。 <a href="termofuse" target='_blank' style="color:#000066">利用規定</a> . <a href="Privacy" target='_blank' style="color:#000066">プライバシーポリシー</a> 私たち.<br>この欄にチェックを入れると、JConnect.co.idにログインするためのボタンが表示されます。</font></center>
            </div>
