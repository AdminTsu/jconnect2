                              ...
                              <nav>
                                <center>
                                  ...
                                  <div class="header-btn d-none f-right d-lg-block">
                                    ...
                                    <a href="<?=base_url()?>jpn/register/RegisterForm_vacancy" class="genric-btn primary small">会社一覧</a>
                                    <a href="<?=base_url()?>jpn/register" class="genric-btn info small">候補者リスト</a>
                                    <a href="<?=base_url()?>jpn/Login_web" class="genric-btn danger small">候補者エントリー</a>
                                        ...
                                        <ul id="navigation">
                                            ...
                                            ?>
                                                <li><a href="#">アクセス</a>
                                                    <ul class="submenu">
                                                        <li>
                                                          <a href="<?=base_url()?>jpn/register/RegisterForm_vacancy">会社一覧</a>
                                                        </li>
                                                        <!-- <li>
                                                          <a href="<?=base_url()?>jpn/login"">企業エントリー</a>
                                                        </li> -->
                                                        <li>
                                                          <a href="<?=base_url()?>jpn/register">候補者リスト</a>
                                                        </li>
                                                        <li>
                                                          <a href="<?=base_url()?>jpn/Login_web">候補者エントリー</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            <?php
                                            ...
                                            ?>
                                                <li><a href="<?php echo base_url(); ?>jpn/Myjconnect">My JConnect</b></a></li>
                                            ...
                                            ?>
                                                ...
                                                <li><a href="<?=base_url()?>jpn/Myjconnect_Client">My JConnect</a></li>
                                                <!-- <li><a href="#">My JConnect</b></a>
                                                    <ul class="submenu">
                                                        <li>
                                                            <a id='menu_web' href="<?php echo base_url(); ?>jpn/Myjconnect_Client">会社概要</a>
                                                        </li>
                                                        <!-- <li>
                                                            <a id='menu_web' href="<?php echo base_url(); ?>jpn/Myjconnect_Client/lowongan">空室状況</a>
                                                        </li>
                                                        <li>
                                                            <a id='menu_web' href="<?php echo base_url(); ?>jpn/Myjconnect_Client/pelamar">ワーカーアプリケーション</a>
                                                        </li> 
                                                    </ul>
                                                </li> -->
                                            <?php
                                            ...
                                            ?>
                                                <!-- <li><a href="#">My JConnect SA</b></a>
                                                    <ul class="submenu">
                                                        <li>
                                                            <a id='menu_web' href="<?php echo base_url(); ?>myjconnect">マイプロフィール</a>
                                                        </li>
                                                        <li>
                                                            <a id='menu_web' href="<?php echo base_url(); ?>myjconnect/pengalaman">経験</a>
                                                        </li>
                                                        <li>
                                                            <a id='menu_web' href="<?php echo base_url(); ?>myjconnect/minat_kerja">興味のある仕事</a>
                                                        </li>
                                                        <li>
                                                            <a href="/myjconnect/lamaran/">私の応募作品</a>
                                                        </li>
                                                    </ul>
                                                </li> -->
                                            ...
                                            ?>
                                            <li><a href="#"><i class="fa fa-globe"></i>&nbsp;&nbsp;(JP)</a>
                                                <ul class="submenu">
                                                    <li>
                         ...
                         <div class="single-footer-caption mb-30">
                             <div class="footer-tittle">
                                 ...
                                 <div class="footer-pera">
                                    <p>
                                        <font color='#ff3377'>どうすればいいのか？</font><br>
                                        日本で働き、インドネシアに帰国したインドネシア人労働者の再就職を支援しています。<br>
                                        日本での技能実習生や経験者で、各分野の能力に応じて公的な証明書を持つ労働者が、当社と連携している企業で再就職できるよう支援します。
                                    </p>
                                     <p>&nbsp;</p>
                                </div>
                             </div>
                        ...
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                ...
                                <ul>
                                    ...
                                    <li><a href="<?=base_url()?>jpn/Find_jobs">求人検索</a></li>
                                    <li><a href="<?=base_url()?>jpn/dashboard/about">について</a></li>
                                    <li><a href="<?=base_url()?>jpn/dashboard/contact">お問い合わせ先</a></li>
