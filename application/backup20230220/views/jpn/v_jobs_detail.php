            ...
            <div class="single-job-items mb-50">
                <div class="job-items">
                    ...
                    <?php if($logoss != '' || $logoss != null){?>
                        <img style="width: 85px;height:85px;border: 1px solid gainsboro;border-radius:3px;border-color:#cccccc;" src="<?=base_url()?>jpn/assets/documents/upload/client/<?=$comidn?>/<?=$logoss?>" alt="">
                    <?php }else{?>
        ...
        <div class="col-xl-4 col-lg-4">
            ...
            <?php
                // }else{
                    if($levels == 2){
            ?>
                        <a href="<?=base_url()?>find_jobs/apply/<?=$idjobs?>" disbaled class="btn">今すぐ申し込む</a>
            <?php
                    }
                    // else{
                    //     echo '
