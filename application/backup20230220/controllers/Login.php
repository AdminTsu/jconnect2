...
class Login extends CI_Controller {
  ...
  {
    $data['title'] = 'JConnect-Login::Management System';
  ...
  function failed($messg=null){
    ...
    if(isset($messg)){
      switch ($messg) {
        case '1':
          $data["messg"] = "<p>Login failed, another session is active</p>?";
          break;
        case '2':
          $data["messg"] = "<p>Your username/password combination is incorrect, please try again.</p>";
          break;
        case '3':
          $data["messg"] = "<p>Your Active Directory username/password is not active. Please verify your account from your registered email or  contact Administrator</p>";
          break;
      }
    }
    $this->load->view('v_login',$data);
