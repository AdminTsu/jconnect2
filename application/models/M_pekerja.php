...
// ------------------------- Master User
  function getPekerjaList(){
    ...
    $this->db->select("a.*,b.COM_DESCRE JNSKLM,CASE WHEN a.PKR_ACTIVE = 0 THEN 'BELUM AKTIF' WHEN a.PKR_ACTIVE = 1 THEN c.COM_DESCRE ELSE c.COM_DESCRE END STATUS");
    ...
    $this->db->where("a.PKR_ACTIVE IN (0,1,2)");
