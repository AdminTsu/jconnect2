...
// ------------------------- Master Job
  ...
  public function get_list_jobs_num($keywrd = null, $lokasi = null, $spsliz = null, $jobpos = null, $typjob = 0, $salmin = 0, $salmax = 0)
  {
    $sql = "
      SELECT count(*) as jml
      FROM T_TRN_JOBPOS a
  ...
  public function get_list_jobs($limit, $start, $keywrd = null, $lokasi = null, $spsliz = null, $jobpos = null, $typjob = 0, $salmin = 0, $salmax = 0)
  {
    ...
    $sql .= "
      ORDER BY JOB_DATCRT,JOB_TITLES
    ";
  ...
  public function get_list_jobs_byclient_num($idclient)
  {
    $sql = "
      SELECT count(*) as jml
      FROM T_TRN_JOBPOS a
  ...
  public function get_list_jobs_byclient($limit, $start, $idclient,$jml)
  {
    // echo "$keywrd ~ $lokasi <br>";
    if($jml > 0){
      $sql = "
