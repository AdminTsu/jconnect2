...
<script type='text/javascript'>
    ...
    $(document).ready(function() {
        ...
        $('#emails').bind('change',function(data){
            var emails = $('#emails').val();
            var gmails = 'gmail.com';

            if(emails.indexOf(gmails) == -1){
                alert('Format email Anda salah, silahkan cek kembali!');
                $('#emails').val('');
                $('#emails').focus();
                return;
            }
        ...
        $('.form-checkbox2').click(function(){
            if($(this).is(':checked')){
                $('#passwrd2').attr('type','text');
            }else{
                $('#passwrd2').attr('type','password');
            }
        });
    ...
    <div class="col-lg-12">
        <form class="form-contact contact_form" method="post" action="/register/validation" id="contactForm" novalidate="novalidate" enctype="multipart/form-data">
            ...
            <div class="register">
                <div class="ccol-sm-12">
                    <div class="form-group"><?=$require?> Username
                        <table>
                            <td>
                                <input class="form-control" name="username" id="username" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Username'" placeholder="Username" placeholder="Username (Harap tidak menggunakan spasi)" required>
                            </td>
                        </table>
                    </div>
                </div>
            ...
            <div class="form-group mt-3">
                <center><button type="submit" name="submit" id="submit" class="button button-contactForm boxed-btn" onclick="startProgress();" disbaled>Daftar</button></center>
                <!-- <br>
