...
<html class="no-js" lang="zxx">
    <head>
        ...
        <link rel="stylesheet" href="<?=base_url()?>resources/css/cookies.css">
...
<script>
  ...
  <body>
    ...
    <!-- Start Cookie Session -->
      ...
      <!-- <div id="cookieNotice" class="chatHeader" style="display: none;background-color: orange;">
        <div id="closeIcon" style="display: none;"></div>
        <div class="title-wrap"><h4><b>Persetujuan Cookie</b></h4></div>
        <div class="content-wrap">
          <div class="msg-wrap">
            <p style="font-size: 10px;">Situs web ini menggunakan cookie atau teknologi serupa, untuk meningkatkan pengalaman menjelajah Anda dan memberikan rekomendasi yang dipersonalisasi. Dengan terus menggunakan situs web kami, Anda menyetujui penggunaan  <a style="color:#115cfa;" href="/privacy" target="_blank"><b>Privacy Policy</b></a>&emsp;
                  <button class="genric-btn info circle" onclick="acceptCookieConsent();" style="cursor: pointer;"><h5>Setuju</h5></button>
              </p>
          </div>
        </div>
      </div> -->
      ...
      <div id="cookieNotice" class="cookie-banner small js-cookie-banner">
        <div class="title-wrap"><h5><b style="color:orange;">Persetujuan Cookie</b></h5></div>
        <div class="content-wrap">
          <div class="cookie-banner__text">
            <p style="font-size: 10px;color:white;text-align: justify;">
              Situs web ini menggunakan cookie atau teknologi serupa, untuk meningkatkan pengalaman menjelajah Anda dan memberikan rekomendasi yang dipersonalisasi. Dengan terus menggunakan situs web kami, Anda menyetujui penggunaan  <a href="/privacy" target="_blank"><b style="color:orange;">Privacy Policy</b></a> kami.&nbsp;
            </p>
            <center>
              <!-- <button class="btn btn_secondary btn_sm cookie-banner__button js-accept-cookies" onclick="acceptCookieConsent();">Terima</button> -->
              <button class="btn btn_secondary btn_sm cookie-banner__button js-accept-cookies" onclick="acceptCookieConsent();">Terima</button>
              <button class="btn btn_secondary btn_sm cookie-banner__button js-accept-cookies" onclick="rejectCookieConsent();">Tolak</button>
            </center>
          </div>
        </div>
      </div> 
                    ...
                    <div class="row align-items-center">
                              ...
                              <nav>
                                <center>
                                  ...
                                  <div class="header-btn d-none f-right d-lg-block">
                                    ...
                                    <a href="<?=base_url()?>login_web" class="genric-btn danger small">Masuk/Login</a>
                      ...
                      <?php } ?>
                        ...
                        <div class="col-lg-1 col-md-1">
                            <!-- Logo -->
                            <div class="logo">
                                <a href="<?=base_url()?>dashboard"><img src="<?=base_url()?>resources/assets/img/logo/Logo_jconnect_new.png" style='width: 100px;height:30px;padding-left: 20px;' alt=""></a>
                            </div>  
                        </div>
                        <!-- --------------------------------------- Website Menu ------------------------------------- -->
    ...
    // echo $content;
        ...
        }elseif($content == 'Lupa Password'){
            $this->load->view('v_lupapassword');
        }elseif($content == 'Reset Password'){
            $this->load->view('v_resetpassword');
            ...
            <div class="container">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-5">
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                ...
                                <ul>
                                    <li>
                                    <p>GRAND GALAXY CITY RSA 3 No 23, Jakasetia, RT.001/RW.002, Pekayon Jaya, Kec. Bekasi Selatan, Kota Bekasi, Jawa Barat 17147, Indonesia</p>
                                    </li>
                                    <li><font color='#EA9000'><i class="ti-tablet"></i>&nbsp;&nbsp;+62 813-1234-5358</font></li>
                                    <li><font color='#EA9000'><i class="ti-email"></i>&nbsp;&nbsp;jconnect.official@jconnect.co.id</font></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-5">
                  <div class="footer-tittle-bottom">
                    <a href="dashboard" style="color:white;"><img src="<?=base_url()?>resources/img/icon_bendera_indo.png" style='width: 37px;height:17px;padding-left: 20px;' alt="">&nbsp;ID</a>
                    <a href="jpn/dashboard" style="color:white;"><img src="<?=base_url()?>resources/img/icon_bendera_jpn.png" style='width: 45px;height:25px;padding-left: 20px;' alt="">&nbsp;JP</a>
                  </div>
                </div>
