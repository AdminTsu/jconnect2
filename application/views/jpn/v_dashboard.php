   ...
   <body>
    ...
    <!-- Start Cookie Session -->
      ...
      <div id="cookieNotice" class="cookie-banner small js-cookie-banner">
        <div class="title-wrap"><h5><b style="color:orange;">クッキーの同意</b></h5></div>
        <div class="content-wrap">
          <div class="cookie-banner__text">
            <p style="font-size: 10px;color:white;text-align: justify;">
              この Web サイトは、閲覧エクスペリエンスを向上させ、パーソナライズされた推奨事項を提供するために、Cookie または同様のテクノロジーを使用しています。当社ウェブサイトの使用を継続することにより、当社の使用に同意したものとみなされます  <a href="/jpn/privacy" target="_blank"><b style="color:orange;">プライバシーポリシー</b></a> 私たちは.&nbsp;
            </p>
            <center>
              <!-- <button class="btn btn_secondary btn_sm cookie-banner__button js-accept-cookies" onclick="acceptCookieConsent();">Terima</button> -->
              <button class="btn btn_secondary btn_sm cookie-banner__button js-accept-cookies" onclick="acceptCookieConsent();">受け入れる</button>
              <button class="btn btn_secondary btn_sm cookie-banner__button js-accept-cookies" onclick="rejectCookieConsent();">拒否する</button>
            </center>
          </div>
        </div>
      </div> 
                             ...
                             <div class="footer-tittle">
                                 ...
                                 <div class="footer-pera">
                                    <p>
                                        ...
                                        JConnect は、これまで協力してきたインドネシアにある日本企業を結びつけることで、日本での勤務経験のあるインドネシアの候補者を結び付けます。私たちはあなたの最高のキャリアを向上させるお手伝いをする準備ができています
                                    </p>
                                     <p>&nbsp;</p>
                                </div>
                             </div>
