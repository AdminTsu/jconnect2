...
$optJOBPOS = array(
    '0'=>'未選択 &emsp;&emsp;&emsp;&emsp;&emsp;',
    '1'=>'シニアマネージャー &emsp;&emsp;&emsp;&emsp;&nbsp;',
    '2'=>'マネジャー &emsp;&emsp;&emsp;&emsp;&nbsp;',
    '3'=>'管理職',
    '4'=>'スタッフ &emsp;&emsp;'
);
$optJENISS = array(
...
<div class="job-listing-area pt-40 pb-40">
    <div class="container">
        <h1 class="mb-30" style='color:#000066; font-size: 32px'>求人情報</h1>
        <div class="row">
            <!-- Left content -->
                    ...
                    <form enctype="multipart/form-data" id='form-submit' method='post' action="<?= base_url() ?>jpn/Find_jobs/search/">
                        <div class="single-listing">
                            ...
                            <div class="single-listing">
                                ...
                                <p><input type="checkbox" name="chkJOBPOS1" id="chkJOBPOS1" value="1" onclick="cb_checked('chkJOBPOS1')" <?=$chk1?> > シニアマネージャー</p>
                                <p><input type="checkbox" name="chkJOBPOS2" id="chkJOBPOS2" value="2" onclick="cb_checked('chkJOBPOS2')" <?=$chk2?> > マネジャー</p>
                                <p><input type="checkbox" name="chkJOBPOS3" id="chkJOBPOS3" value="3" onclick="cb_checked('chkJOBPOS3')" <?=$chk3?> > 管理職</p>
                                <p><input type="checkbox" name="chkJOBPOS4" id="chkJOBPOS4" value="4" onclick="cb_checked('chkJOBPOS4')" <?=$chk4?> > スタッフ</p>
                            </div>
                            <!-- <br><br><br> -->
