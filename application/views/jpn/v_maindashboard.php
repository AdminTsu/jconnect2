            ...
            <div class="container py-5">
                <div class="row">
                    <div class="col-xl-12 banner-title">
                        <h1>インドネシアで最高の専門求人ポータルサービス. <br/>日本での就労経験のある候補者とインドネシアにある日系企業を結びつける</h1>
                        <h2>日本での就労経験を活かして、次のステップへ。</h2>
                    </div>

                    <div class="col-xl-5">
                        <div class="hero__caption banner-description">
                            <div class="col-xl-12">
                            日本での就労経験を活かして、次のステップへ。<br><br>
                            </div>
                            <div class="col-xl-12">
                            以下の資格をお持ちの方 :
                                <ul class="list-check">
                                    <li>日本でインターン/就労したことがある <b style='color:#EA9000;'>(必須)</b></li>
                                    <li>日本語レベル認定証 <b style='color:#EA9000;'>(必須)</b></li>
                                    <li>日本滞在中のビザ許可証の写真 <b style='color:#EA9000;'>(必須)</b></li>
                                    <li>スペシャルスキルワーカー(SSW)認定証 <b style='color:#EA9000;'>(該当する場合)</b></li>
                                    <li>インターンシップの証明書（JITCO/OTIT） <b style='color:#EA9000;'>(該当する場合)</b></li>
                                </ul>
                            </div>
                            <div class="col-xl-12 reveal banner-cta">
                                <!-- <a style='color:#cc0000;' href="<?= base_url() ?>register">disini</a>.  -->
                                詳細については、お問い合わせメニューまたはWhatsappでお問い合わせください。
                                <div class="banner-cta-button">
                                    <a href="<?= base_url() ?>register" class="btn btn-signup">登録</a><br>
                        ...
                        <form enctype="multipart/form-data" id='form-submit' method='post' action="<?= base_url() ?>Find_jobs/search/">
                            ...
                            <fieldset class="row">
                                ...
                                <div class="col-md-12 text-right">
                                    <button href="#" type="submit" id=submit class="genric-btn primary circle" onclick='jvSearch();'>検索</button>
                                </div>
                            </fieldset>
                        </form>
                    </div>
                    ...
                    <div class="col-xl-10">
                        ...
                        if($idents != '' || $idents != null){
                            ...
                            if($iduser == '' || $iduser == null){
                                ...
                                $btn_detail = '<a id=detail href="'.base_url().'jpn/find_jobs/find_jobs_detail/'.$idents.'">詳細</a>';
                            }
                        ?>
                            <div class="single-job-items mb-30">
                                <div class="job-items">
                                    ...
                                    <?php if($logoss != '' || $logoss != null){?>
                                        <a href="<?=base_url()?>jpn/Find_jobs/Find_Jobs_detail/<?=$idents?>"><img style="width: 85px;height:85px;border: 1px solid gainsboro;border-radius:3px;border-color:#cccccc;" src="<?=base_url()?>assets/documents/upload/client/<?=$comidn?>/<?=$logoss?>" alt=""></a>
                                    <?php }else{?>
