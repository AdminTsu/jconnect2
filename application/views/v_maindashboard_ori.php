            ...
            <div class="col-xl-10">
                    ...
                    <div class="single-job-items mb-30">
                        <div class="job-items">
                            ...
                            <?php if($logoss != '' || $logoss != null){?>
                                <a href="<?=base_url()?>Find_jobs/Find_Jobs_detail/<?=$idents?>"><img style="width: 85px;height:85px;border: 1px solid gainsboro;border-radius:3px;border-color:#cccccc;" src="<?=base_url()?>assets/documents/upload/client/<?=$comidn?>/<?=$logoss?>" alt=""></a>
                            <?php }else{?>
                ...
                ?>
                        <div class="single-job-items mb-30">
                            <div class='items-link f-right'>
                                <span>
                                    <p>Maaf, Tidak ada data Pekerjaan Terbaru</p>
                                </span>
                            </div>
                        </div>
                <?php
