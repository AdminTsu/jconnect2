...
?>
<meta name="description" content="Isi dan kirim formulir pendaftaran untuk memasang iklan lowongan kerja di platform ini. Temukan kandidat potensial yang sesuai dengan kebutuhan perusahaan Anda">
...
<script>
    $(document).ready(function() {
        ...
        $('.form-checkbox').click(function(){
            if($(this).is(':checked')){
                $('#txtPASSWD').attr('type','text');
            }else{
                $('#txtPASSWD').attr('type','password');
            }
        });
...
<!-- <section class="contact-section"> -->
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8">
                <form class="form-contact contact_form" method="post" id="contactForm" action="/register/validation_c" novalidate="novalidate" enctype="multipart/form-data">
                    <?php echo $this->session->flashdata('msg'); ?>
                    <div class="row">
                                <div class="col-12">
                                    <font size=2 style="color:#999999">Apakah Anda sedang merekrut untuk suatu posisi sekarang? Isi formulir mudah di bawah ini dengan detail perusahaan dan kontak PIC Anda.</font>
                                </div>
                                <div class="col-12">
                                    &nbsp;
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div ><?=$require?> Lokasi Negara Perusahaan
                                     <select name="cmbCONTRY" id="cmbCONTRY" class="form-control w-100" onchange="jvChangeContry(this.value)" required>
                                        <?php
                                            foreach($optCountry as $val=>$desc){
                            ...
                            <div class="col-12">
                                <center><input type="checkbox" name="chkPrivacy" id="chkPrivacy" value"setuju" onchange="jvChangePrivacy()"> <font size=2 style="color:#999999">Dengan mencentang kolom ini, berarti anda membaca dan menyetujui <a href="<?=base_url()?>termofuse" target='_blank' style="color:#000066">Kebijakan Penggunaan</a> dan <a href="<?=base_url()?>privacy" target='_blank' style="color:#000066">Kebijakan Privasi</a> kami.</font></center>
                            </div>
