...
<script>
    ...
    function acceptCookieConsent(){
        deleteCookie('user_cookie_consent');
        setCookie('user_cookie_consent', 1, 30);
        document.getElementById("cookie-popup2").style.display = "none";
    }
    ...
    if(cookie_consent != ""){
        ...
        document.getElementById("cookie-popup2").style.display = "block";
    }
    // END script Cookies
</script>
  <body>
    ...
    <!-- Start Cookie Session -->
        ...
        <!-- <div class='chatText'>
          <div id="cookieNotice" class="chatHeader" style="display: none;background-color: orange;">
            ...
            <div class="content-wrap">
              <div class="msg-wrap">
                <p>Situs web ini menggunakan cookie atau teknologi serupa, untuk meningkatkan pengalaman menjelajah Anda dan memberikan rekomendasi yang dipersonalisasi. Dengan terus menggunakan situs web kami, Anda menyetujui penggunaan  <a style="color:#115cfa;" href="/privacy" target="_blank"><b>Privacy Policy</b></a></p>
                <div class="btn-wrap">
                    <button class="btn-primary" onclick="acceptCookieConsent();" style="cursor: pointer;"><h5>Setuju</h5></button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div id="cookie-popup">
          <p>Persetujuan Cookie</p>
          <p>
            Situs web ini menggunakan cookie atau teknologi serupa, untuk meningkatkan pengalaman menjelajah Anda dan memberikan rekomendasi yang dipersonalisasi. Dengan terus menggunakan situs web kami, Anda menyetujui penggunaan<br><a href="/privacy" class="link" target="_blank">Info Lanjut &rarr;</a>
          </p>        
          <button class="cookie-popup__button" onclick="acceptCookieConsent();" style="cursor: pointer;">Setuju</button>
        </div>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>

        <div id="cookie-popup2" class="cookie-banner small js-cookie-banner" role="alert">
          <div class="cookie-banner__text">
            MyApp uses cookies to personalize your experience on our website. By continuing to use this site, you agree to our <a href="https://myapp.zetwin.com/cookie-policy" class="link">cookie policy</a>.
          </div>
          <button class="btn btn_secondary btn_sm cookie-banner__button js-accept-cookies" onclick="acceptCookieConsent();">Okay</button>
        </div>
    <!-- End Cookie Session -->
                              ...
                              <nav>
                                <center>
                                  ...
                                  <div class="header-btn d-none f-right d-lg-block">
                                    ...
                                    <a>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</a>
                                    <a>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</a>
