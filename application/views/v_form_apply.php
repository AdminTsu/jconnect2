...
<div class="row">
    <div class="col-12">
        <center><h2 class="contact-title">Form Pengajuan</h2></center>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-between">
            ...
            <div class="col-xl-8 col-lg-8">
                ...
                <form class="form-contact contact_form" action="/Find_jobs/submitapply/<?=$idjobs?>/<?=$idpkrj?>" method="get" id="contactForm" novalidate="novalidate">
                    <div class="col-12">Buatlah promosi anda sebaik mungkin (Saran)</div>
                    <div class="col-12">
                        <div class="form-group">
                            <textarea class="form-control w-100" name="reason" id="reason" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Sampaikan kepada pihak pemberi kerja hal apa yang membuat pemberi kerja merasa anda paling cocok untuk posisi ini. Jelaskan keterampilan khusus anda dan bagaimana anda dapat berkontribusi. Hindari kata-kata seperti saya seorang yang bertanggung jawab'" placeholder="(Saran) Sampaikan kepada pihak pemberi kerja hal apa yang membuat pemberi kerja merasa anda paling cocok untuk posisi ini. Jelaskan keterampilan khusus anda dan bagaimana anda dapat berkontribusi. Hindari kata-kata seperti saya seorang yang bertanggung jawab"></textarea>
                        </div>
                    </div>
                    <div class="col-12">
                        <center><input type="checkbox" name="chkPrivacy" id="chkPrivacy" value"setuju" onchange="jvChangePrivacy()"> <font size=2 style="color:#cccccc">Dengan mengklik 'Lamar', berarti anda telah membaca dan sepakat dengan kebijakan kehadiran wawancara dengan Jconnect.com dan pihak perusahaan terkait</font></center>
                    </div>
                    <?php echo $this->session->flashdata('msg'); ?>
                    <div class="form-group mt-3">
                        <center><button type="submit" name="submit" id="submit" class="button button-contactForm boxed-btn" disbaled>Lamar</button></center>
                    </div>
                </form>
            ...
            <div class="col-xl-4 col-lg-4">
                ...
                <div class="post-details4  mb-40">
                    ...
                    <?php if($logoss != '' || $logoss != null){?>
                        <a href="<?=base_url()?>dashboard/Find_Jobs_detail"><img style="width: 50px;height:50px;border: 1px solid gainsboro;border-radius:3px;border-color:#cccccc;" src="<?=base_url()?>assets/documents/upload/client/<?=$idents?>/<?=$logoss?>" alt=""></a>
                    <?php }else{?>
                        <a href="#"><img style="width: 85px;height:85px;border: 1px solid gainsboro;border-radius:3px;border-color:#cccccc;" src="<?=base_url()?>resources/img/no-image2.jpg" alt="Avatar" class="image"></a>
                    <?php }?>
                    </div><br>
                    <div class="small-section-tittle">
                    ...
                    <table class="small-section-tittle">
                        <tr><td>Nama</td><td>&nbsp;:&nbsp;</td><td><?=$comnam?></td></tr>
                        <tr><td>Web</td><td>&nbsp;:&nbsp;</td><td><span><a href="https://<?=$websit?>" target="_blank"><?=$websit?></a></td></tr>
                        <tr><td>Email</td><td>&nbsp;:&nbsp;</td><td><?=$emilct?></td></tr>
                    </table>
               </div>
            </div>
        </div>
