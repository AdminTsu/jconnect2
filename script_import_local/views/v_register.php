...
<div class="row">
    <div class="col-12">
        <center><h2 class="contact-title">Buat Akun Baru</h2></center>
    </div>
    <div class="col-lg-12">
        <form class="form-contact contact_form" action="/register/validation" method="post" id="contactForm" novalidate="novalidate" enctype="multipart/form-data">
            ...
            <div class="register">
                ...
                <div class="ccol-sm-12">
                    <div class="form-group"><?=$require?> Nama Lengkap
                        <table>
                            <td>
                                <input class="form-control valid" name="name" id="name" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nama Lengkap'" placeholder="Nama Lengkap" required>
                            </td>
                        </table>
                    </div>
                </div>
                <div class="ccol-sm-12">
                    <div class="form-group"><?=$require?> Email
                        <table>
                            <td>
                                <input class="form-control valid" name="email" id="email" type="email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Alamat Email'" placeholder="Alamat Email" required>
                            </td>
                        </table>
                    </div>
                </div>
            ...
            <div class="form-group mt-3">
                <center><button type="submit" name="submit" id="submit" class="button button-contactForm boxed-btn" onclick='jvSend();' disbaled>Daftar</button></center>
                <!-- <br>
