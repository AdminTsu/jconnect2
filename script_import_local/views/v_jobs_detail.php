                        ...
                        <div class="single-job-items mb-50">
                            <div class="job-items">
                                ...
                                <?php if($logoss != '' || $logoss != null){?>
                                    <a href="<?=base_url()?>find_jobs/find_jobs_detail"><img style="width: 85px;height:85px;border: 1px solid gainsboro;border-radius:3px;border-color:#cccccc;" src="<?=base_url()?>assets/documents/upload/client/<?=$comidn?>/<?=$logoss?>" alt=""></a>
                                <?php }else{?>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="post-details3  mb-50">
                          ...
                          <ul>
                              ...
                              <li>Gaji :  <span>Rp. <?=number_format($salmax,0)?>/bulan</span></li>
                        ...
                        <div class="post-details4  mb-50">
                           ...
                           <div class="small-section-tittle">
                            ...
                            <ul>
                                ...
                                <li>Web   &nbsp;&nbsp;&nbsp;: <span><a href="https://<?=$websit?>"><?=$websit?></a></span></li>
