    ...
    <div class="container">
        <div class="row justify-content-between">
            ...
            <div class="col-xl-7 col-lg-8">
                ...
                <div class="single-job-items mb-50">
                    <div class="job-items">
                        ...
                        <?php if($fotoss != '' || $fotoss != null){?>
                            <img style="width: 85px;height:85px;border: 1px solid gainsboro;border-radius:3px;border-color:#cccccc;" src="<?=base_url()?>assets/documents/upload/pekerja/<?=$idpkrj?>/<?=$fotoss?>" alt="">
                        <?php }else{?>
                ...
                <form class="form-contact contact_form" action="/find_jobs/submitapply/<?=$idjobs?>" method="get" id="contactForm" novalidate="novalidate">
            ...
            <div class="col-xl-4 col-lg-4">
                ...
                <div class="post-details4  mb-50">
                    ...
                    <table class="small-section-tittle">
                        ...
                        <tr><td>Web</td><td>&nbsp;:&nbsp;</td><td><span><a href="https://<?=$websit?>"><?=$websit?></a></td></tr>
