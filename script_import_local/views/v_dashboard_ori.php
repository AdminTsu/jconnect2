...
<html class="no-js" lang="zxx">
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="<?=base_url()?>resources/assets/img/logo/logo.png" alt="">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-2">
                            <!-- Logo -->
                            <div class="logo">
                                <a href="index.html"><img src="<?=base_url()?>resources/assets/img/logo/logo.png" alt=""></a>
                            </div>  
                        </div>
                                ...
                                <div class="main-menu">
                                    <nav class="d-none d-lg-block">
                                        <ul id="navigation">
                                            ...
                                            <li><a href="<?=base_url()?>jobfinderportal-master/job_listing.html">Find a Jobs</a></li>
                                            <li><a href="<?=base_url()?>jobfinderportal-master/about.html">About</a></li>
                                            <li><a href="#">Page</a>
                                                <ul class="submenu">
                                                    <li><a href="<?=base_url()?>jobfinderportal-master/blog.html">Blog</a></li>
                                                    <li><a href="<?=base_url()?>jobfinderportal-master/single-blog.html">Blog Details</a></li>
                                                    <li><a href="<?=base_url()?>jobfinderportal-master/elements.html">Elements</a></li>
                                                    <li><a href="<?=base_url()?>jobfinderportal-master/job_details.html">job Details</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="<?=base_url()?>jobfinderportal-master/contact.html">Contact</a></li>
                                        </ul>
                                    </nav>
                                </div>          
                                <!-- Header-btn -->
                                <div class="header-btn d-none f-right d-lg-block">
                                    <a href="<?=base_url()?>jobfinderportal-master/" class="btn head-btn1">Register</a>
    ...
    <main>
        ...
        <div class="slider-area ">
            ...
            <div class="slider-active">
                <div class="single-slider slider-height d-flex align-items-center" data-background="<?=base_url()?>resources/assets/img/hero/h1_hero.jpg">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-6 col-lg-9 col-md-10">
                                <div class="hero__caption">
                                    <h1>Find the most exciting startup jobs or Job</h1>
                                </div>
                            </div>
                        </div>
                        <!-- Search Box -->
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-10">
                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                <div class="company-img">
                                    <a href="job_details.html"><img src="<?=base_url()?>resources/assets/img/icon/job-list1.png" alt=""></a>
                                </div>
                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                <div class="company-img">
                                    <a href="job_details.html"><img src="<?=base_url()?>resources/assets/img/icon/job-list2.png" alt=""></a>
                                </div>
                                <div class="job-tittle">
                                    <a href="job_details.html"><h4>Digital Marketer</h4></a>
                                    <ul>
                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                <div class="company-img">
                                    <a href="job_details.html"><img src="<?=base_url()?>resources/assets/img/icon/job-list3.png" alt=""></a>
                                </div>
                                <div class="job-tittle">
                                    <a href="job_details.html"><h4>Digital Marketer</h4></a>
                                    <ul>
                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                <div class="company-img">
                                    <a href="job_details.html"><img src="<?=base_url()?>resources/assets/img/icon/job-list4.png" alt=""></a>
                                </div>
                                <div class="job-tittle">
                                    <a href="job_details.html"><h4>Digital Marketer</h4></a>
                                    <ul>
        ...
        <div class="apply-process-area apply-bg pt-150 pb-150" data-background="<?=base_url()?>resources/assets/img/gallery/how-applybg.png">
            <div class="container">
                <!-- Section Tittle -->
                <div class="row">
                    <div class="col-lg-12">
                                ...
                                <div class="testimonial-caption ">
                                    ...
                                    <div class="testimonial-founder  ">
                                        <div class="founder-img mb-30">
                                            <img src="<?=base_url()?>resources/assets/img/testmonial/testimonial-founder.png" alt="">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="<?=base_url()?>resources/assets/img/blog/home-blog1.jpg" alt="">
                                    <!-- Blog date -->
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="<?=base_url()?>resources/assets/img/blog/home-blog2.jpg" alt="">
                                    <!-- Blog date -->
                                    <div class="blog-date text-center">
                                        <span>24</span>
                                        <p>Now</p>
                        ...
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                ...
                                <ul>
                                    ...
                                    <li><a href="#">Phone : +62857-7046-0065</a></li>
                                    <li><a href="#">Email : tsubame@gmail.com</a></li>
                                </ul>
                            </div>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made by <a href="<?=base_url()?>" target="_blank">TsuBaSys</a>
