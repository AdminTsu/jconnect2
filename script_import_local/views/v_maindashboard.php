...
<script type="text/javascript">
    $(document).ready(function(){
        $( "#txtKEYWRD" ).autocomplete({
            serviceUrl: '<?=base_url()?>dashboard/search',   // Kode php untuk prosesing data
            dataType: "JSON",           // Tipe data JSON
            onSelect: function (suggestion) {
                $("#txtKEYWRD" ).val("" + suggestion.txtKEYWRD);
            }
        });
    });
            ...
            source: cityTags
                ...
                <div class="slider-area ">
                    ...
                    <div class="slider-active">
                        <!-- <div class="single-slider slider-height d-flex align-items-center" data-background="<?=base_url()?>resources/assets/img/gallery/how-applybg.png"> -->
                        <!-- <div class="single-slider slider-height d-flex align-items-center" data-background="<?=base_url()?>resources/lelang/images/auction/featured/featured-bg-2.png"> -->
                                ...
                                <div class="row">
                                    <div class="col-xl-7">
                                        <div class="hero__caption">
                                            ...
                                            <!-- <br><br><br> -->
                                            <!-- <br><br><br> -->
                                            <!-- <p style='color:#000066;text-align: justify;'><font size=10>&nbsp;&nbsp;Temukan pekerjaan yang<br> sesuai dengan kriteria Anda</font></p> -->
                                            <h1 style='color:#000066;'><br>Temukan pekerjaan yang sesuai dengan kriteria Anda</h1>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-style-10">
                                        <form enctype="multipart/form-data" id='form-submit' method='post' action="<?= base_url() ?>find_jobs/search/">
                                            ...
                                            <fieldset>
                                                ...
                                                <input type="text" placeholder="Ketik Spesialisasi" name="txtSPSLIZ" id="txtSPSLIZ">
                                                ...
                                                <input type="text" placeholder="Ketik Lokasi" name="txtLOCKSI" id="txtLOCKSI">
                                                ...
                                                <input type="text" placeholder="Ketik Kata kunci" name="txtKEYWRD" id="txtKEYWRD">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-10">
                        <div class="cv-caption text-center">
                            <p class="pera1"><font style='color:#EA9000;'>PAKET UNGGULAN PELAYANAN TERBAIK</font></p>
                                ...
                                if($tahuns == 0){
                                    if($bulans == 0){
                                        if($hariss == 0){
                                            ...
                                            $durasi = "$hariss Hari $jamnya Jam $menits Menit $detiks Detik yang lalu";
                                        }
                                    }else{
                                        $durasi = "$bulans Bulan $hariss Hari $jamnya Jam $menits Menit $detiks Detik yang lalu";
                                    }
                                }else{
                                    $durasi = "$tahuns Tahun $bulans Bulan $hariss Hari $jamnya Jam $menits Menit $detiks Detik yang lalu";
                                }
