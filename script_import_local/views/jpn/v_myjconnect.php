            ...
            <div class="col-xl-3 col-lg-3 col-md-4">
                ...
                <div class="job-category-listing mb-50" id='side_myjconnect'>
                        <div class="single-listing">
                            ...
                            <div class="single-listing">
                                <a id='menu_web' href="<?php echo base_url(); ?>jpn/myjconnect/pengalaman/<?=$usr_idents?>"><i class="fa fa-briefcase"></i>&nbsp;&nbsp;経験</a>
                            </div><br>
                            <div class="single-listing">
                                <a id='menu_web' href="<?php echo base_url(); ?>jpn/myjconnect/minat_kerja/<?=$usr_idents?>"><i class="fa fa-cogs"></i>&nbsp;&nbsp;興味のある仕事</a>
                            </div><br>
                            <div class="single-listing">
                            ...
                            <?php if($jenis == 'view'){ ?>
                            <div class="single-listing">
                                <a id='menu_web' href="<?php echo base_url(); ?>jpn/myjconnect/<?=$link_menu?>/<?=$usr_idents?>" class="genric-btn primary-border small"><i class="fa fa-edit">&nbsp;&nbsp;変更</i></a>
                            </div><br>
                            <?php } ?>
...
<!-- -------------------------------------------------------  edit profile --------------------------------------------------------------- -->
        ...
        <form action="/jpn/myjconnect/profile_simpan/<?=$usr_idents?>" method="post" id="contactForm" novalidate="novalidate" enctype="multipart/form-data"> 
            <table class='table1'>                
                                ...
                                <td colspan=2 style='text-align: right;'>
                                    ...
                                    <?php if($jenis == 'view'){ ?>
                                        <div id='single-listing' class="single-listing">
                                            <a id='menu_web' href="<?php echo base_url(); ?>jpn/myjconnect/profile_edit/<?=$usr_idents?>" class="genric-btn primary-border small"><i class="fa fa-edit">&nbsp;&nbsp;変更</i></a>
                                        </div><br>
                                    <?php }else{ ?>
                                        <div id='single-listing' class="single-listing">
