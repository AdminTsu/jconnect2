...
<script type="text/javascript">
    $(document).ready(function(){
        $( "#txtKEYWRD" ).autocomplete({
            serviceUrl: '<?=base_url()?>jpn/dashboard/search',   // Kode php untuk prosesing data
                                ...
                                <div class="row">
                                    <div class="col-xl-7">
                                        <div class="hero__caption">
                                            <h1 style='color:#000066;'><br>自分の条件にあった仕事を探す</h1>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-style-10">
                                        <form enctype="multipart/form-data" id='form-submit' method='post' action="<?= base_url() ?>jpn/find_jobs/search/">
                                            <fieldset>
                                                ...
                                                <input type="text" placeholder="タイプ別専門性" name="txtSPSLIZ" id="txtSPSLIZ">
                                                <label for="typjob"><font size=4>所在地</font></label>
                                                <input type="text" placeholder="タイプ 場所" name="txtLOCKSI" id="txtLOCKSI">
                                                ...
                                                <input type="text" placeholder="タイプ キーワード" name="txtKEYWRD" id="txtKEYWRD">
                        ...
                        ?>
                            <div class="single-job-items mb-30">
                                ...
                                <div class="items-link f-right">
                                    <a href="<?=base_url()?>jpn/dashboard/find_jobs_detail/<?=$idents?>">詳細</a>
                                </div>
                                <div class="items-link f-right">
                                    <span><br>ポスト <?=$durasi?> </span>
                                </div>
                            </div>
                        <?php
                            }else{
