            ...
            <div class="col-xl-3 col-lg-3 col-md-4">
                ...
                <div class="job-category-listing mb-50" id='side_myjconnect'>
                        <div class="single-listing">
                            ...
                            <div class="single-listing">
                                <a id='menu_web' href="<?php echo base_url(); ?>myjconnect_client"><i class="fa fa-user"></i>&nbsp;&nbsp;会社概要</a>
                            </div><br>
                            <div class="single-listing">
                                <a id='menu_web' href="<?php echo base_url(); ?>myjconnect_client/ubah_password/<?=$usr_idents?>"><i class="fa fa-key"></i>&nbsp;&nbsp;パスワードの変更</a>
                            </div><br>
                            <?php if($jenis == 'view'){ ?>
                            <div class="single-listing">
                                <a id='menu_web' href="<?php echo base_url(); ?>myjconnect_client/<?=$link_menu?>/<?=$idents?>" class="genric-btn primary-border small"><i class="fa fa-edit">&nbsp;&nbsp;変更</i></a>
                            </div><br>
                            <?php } ?>
...
<!-- ----------------------------------------------------  view profile ------------------------------------------------------------- -->
            <table class='table1'>
                ...
                <tr><td>会社概要</td><td colspan=3>: <?=$descre?></td></tr>
                <tr><td>会員番号</td><td colspan=3>: <?=$mmbrno?></td></tr>
                <tr><td>住所</td><td colspan=3>: <?=$addres?></td></tr>
                <tr><td>所在地</td><td colspan=3>: <?=$provnc?> - <?=$cityss?>, <?=$contry?></td></tr>
                <tr><td>ファックス</td><td colspan=3>: <?=$faxnom?></td></tr>
                <tr><td>掛かり付けの人</td><td colspan=3>: <?=$picnya?></td></tr>
...
<!-- -------------------------------------------------------  edit profile --------------------------------------------------------------- -->
        ...
        <form action="/jpn/myjconnect_client/profile_simpan/<?=$idents?>" method="post" id="contactForm" novalidate="novalidate" enctype="multipart/form-data"> 
            <table class='table1'>                
                    ...
                    <td>
                        <table class='table2'>
                            ...
                            <tr>
                                <td>電子メール</td>
                                <td>
                                    <input class="form-control" name="txtEMAILS" id="txtEMAILS" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = '電子メール'" placeholder="電子メール" value='<?=$emails?>' style='width: 500px;text-align: left;' readonly>
                                </td>
                            </tr>
                            <tr>
                                <td>ウェブサイト</td>
                                <td>
                                    <input class="form-control" name="txtWEBSIT" id="txtWEBSIT" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'ウェブサイト'" placeholder="ウェブサイト" value='<?=$websit?>' style='width: 500px;text-align: left;'>
                                </td>
                            </tr>
                            <tr>
                                <td>電話番号</td>
                            ...
                            <tr>
                                <td>担当者名</td>
                                <td>
                                    <input class="form-control" name="txtCONTAC" id="txtCONTAC" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = '担当者名'" placeholder="担当者名" value='<?=$picnya?>' style='width: 500px;text-align: left;'>
                                </td>
                            </tr>
                            <tr>
                                <td>携帯電話番号</td>
                                ...
                                <td colspan=2 style='text-align: right;'>
                                    ...
                                    <?php if($jenis == 'view'){ ?>
                                        <div id='single-listing' class="single-listing">
                                            <a id='menu_web' href="<?php echo base_url(); ?>jpn/myjconnect_client/profile_edit/<?=$idents?>" class="genric-btn primary-border small"><i class="fa fa-edit">&nbsp;&nbsp;変更</i></a>
                                        </div><br>
                                    <?php }else{ ?>
                                        <div id='single-listing' class="single-listing">
