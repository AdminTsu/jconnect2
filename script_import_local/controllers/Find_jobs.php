  ...
  var $levels;
    ...
    function SubmitApply($idjobs){
        ...
        if($userid){
            ...
            $this->session->set_flashdata('msg','<div class="alert alert-success"><strong>Selamat lamaran anda berhasil terkirim. </strong>Mohon menunggu konfirmasi dari kami.<a href=/login/destroy_session>Hancurkan Sesi</a>?&emsp;
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-</div>');
        }else{
            $this->session->set_flashdata('msg','<div class="alert alert-danger"><strong>Maaf, lamaran anda belum berhasil.</strong><a href=/login/destroy_session>Hancurkan Sesi</a>?&emsp;
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-</div>');
        }
