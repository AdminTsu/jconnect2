...
// ------------------------- Master Job
  ...
  public function get_list_jobs_num($keywrd=null,$lokasi=null,$spsliz=null,$jobpos=0,$typjob=0,$salmin=0,$salmax=0)
  {
    $sql = "
      SELECT count(*) as jml
      FROM T_TRN_JOBPOS a
  ...
  public function get_list_jobs($limit, $start, $keywrd=null,$lokasi=null, $spsliz=null,$jobpos=0,$typjob=0,$salmin=0,$salmax=0)
  {
