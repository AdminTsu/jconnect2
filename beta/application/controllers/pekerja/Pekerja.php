...
class Pekerja extends MY_Controller {
    ...
    function edit($type=null,$param=null,$source=null){
        $arrColumn = array(
            ...
            'cmbCONTRY' =>'PKR_CONTRY',
            'cmbPROVNC' =>'PKR_PROVNC',
            'cmbCITYSS' =>'PKR_CITYSS',
        ...
        $arrTable[] = array('group'=>3, 'urutan'=>$urutan++, 'type'=> ($type=='view') ? "view" : 'num', 'namanya' =>'txtEXPSAL','label'=>'Perkiraan Gaji',  'size'=>'100','value'=> isset($column) ? $txtEXPSAL : "");
