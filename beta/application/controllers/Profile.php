...
class Profile extends MY_Controller {
    ...
    function vinfo_rekanan()
    {
        ...
        $arrTable[] = array('group'=>1, 'urutan'=>$urutan++, 'type'=> ($type=='view') ? "view" : 'txt', 'namanya' =>'txtNAMESS','label'=>'Nama Client',  'size'=>'400','value'=> isset($column) ? $txtNAMESS : "");
        ...
        $arrTable[] = array('group'=>1, 'urutan'=>$urutan++, 'type'=> ($type=='view') ? "view" : 'txt', 'namanya' =>'txtBDLAIN','label'=>'Bidang Lain',  'size'=>'$00','value'=> isset($column) ? $txtBDLAIN : "");
    ...
    function save_rekanan(){
        ...
        $CLI_LOGNID = $this->input->post('txtLOGNID');
        ...
        $txtCONTAC = strtoupper($this->input->post('txtCONTAC'));
