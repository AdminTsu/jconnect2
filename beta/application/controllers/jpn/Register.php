        ...
        if((empty($emails) && empty($namess) && empty($logins) && empty($passwd) && empty($filbhs) && empty($visafl) && empty($magang) && empty($filssw) && empty($status))){
            ...
            if(empty($logins)){
                $this->session->set_flashdata('msg_logins', '
                    <div class="alert alert-danger" role="alert">ユーザー名が未入力です!&emsp;
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>');
                ...
                $this->session->set_flashdata('msg_passwd', '
                    <div class="alert alert-danger" role="alert">パスワードが未入力です!&emsp;
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>');
                ...
                $this->session->set_flashdata('msg_namess', '
                    <div class="alert alert-danger" role="alert">フルネームが未入力です!&emsp;
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>');
                ...
                $this->session->set_flashdata('msg_emails', '
                    <div class="alert alert-danger" role="alert">電子メールが未入力です!&emsp;
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>');
                ...
                $this->session->set_flashdata('msg_filbhs', '
                    <div class="alert alert-danger" role="alert">日本のレベルは満たされていない!&emsp;
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>');
                ...
                $this->session->set_flashdata('msg_visafl', '
                    <div class="alert alert-danger" role="alert">日本へのビザは未取得です!&emsp;
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>');
                ...
                $this->session->set_flashdata('msg_filssw', '
                    <div class="alert alert-danger" role="alert">SSW証明書が未記入です!&emsp;
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>');
                ...
                $this->session->set_flashdata('msg_magang', '
                    <div class="alert alert-danger" role="alert">インターンシップ証明書がまだ記入されていない！&emsp;
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>');
                ...
                $this->session->set_flashdata('msg_status', '
                    <div class="alert alert-danger" role="alert">ステータスが未入力です！&emsp;
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>');
                ...
                if(filter_var($emails, FILTER_VALIDATE_EMAIL) === false){
                    $this->session->set_flashdata('msg_emails', '
                        <div class="alert alert-danger" role="alert">メールの形式が正しくありません。正しく記入してください！&emsp;
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>');
                ...
                $subjectItem = "
                    ...
                    <html>
                        ...
                        <body>
                            ...
                            <h4><a href='".base_url()."jpn/register/activate/".$IDENTS."/".$code."'>マイアカウントの有効化</a></h4>
                        </body>
                        <footer>
                            <p>
                                よろしくお願いします。,<br><br>
            ...
            if(filter_var($emails, FILTER_VALIDATE_EMAIL) === false){
                ...
                if(empty($usrnam)){
                    ...
                    $this->session->set_flashdata('msg_comnam', '
                        <div class="alert alert-danger" role="alert">会社名が記入されていない！&emsp;
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>');
                    ...
                    $this->session->set_flashdata('msg_namess', '
                        <div class="alert alert-danger" role="alert">PICの名前が記入されていない！&emsp;
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>');
                    ...
                    $this->session->set_flashdata('msg_telpon', '
                        <div class="alert alert-danger" role="alert">会社の電話番号が記入されていない！&emsp;
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>');
                    ...
                    $this->session->set_flashdata('msg_mobile', '
                        <div class="alert alert-danger" role="alert">会社/PICの携帯電話番号が未入力です!&emsp;
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>');
                    ...
                    $this->session->set_flashdata('msg_addres', '
                        <div class="alert alert-danger" role="alert">会社の住所が記入されていない！&emsp;
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>');
                    ...
                    $this->session->set_flashdata('msg_emails', '
                        <div class="alert alert-danger" role="alert">会社のメールアドレスが未入力です！&emsp;
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>');
                    ...
                    $this->session->set_flashdata('msg_contry', '
                        <div class="alert alert-danger" role="alert">国はまだ決まっていない!&emsp;
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>');
                    ...
                    $this->session->set_flashdata('msg_provnc', '
                        <div class="alert alert-danger" role="alert">都道府県はまだ決まっていない！&emsp;
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>');
                    ...
                    $this->session->set_flashdata('msg_cityss', '
                        <div class="alert alert-danger" role="alert">都市はまだ決定していません!&emsp;
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>');
                    ...
                    $subjectItem = "
                        <html>
                            ...
                            <body>
                                ...
                                <h4><a href='".base_url()."jpn/register/activate_c/".$IDENTS."/".$code."'>アカウントの有効化はこちら</a></h4>
                            </body>
                            <footer>
                                <p>
                                    よろしくお願いします,<br><br>
