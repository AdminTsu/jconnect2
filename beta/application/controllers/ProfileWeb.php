        ...
        $content = '
            <div class="col-lg-8">
                <form form-group mt-3 method="post" action="/profileweb/save" id="'.$formname.'">
                    <div class="row">
                        <div class="col-12">
                            <div style="text-align: left;"><b><h4>Ubah Password</h4></b></div>
                        </div><br><br>
                        <div class="col-4">
                        ...
                        <div class="col-8">
                            <div class="form-group">
                                <input class="form-control valid" name="name" id="name" type="text"  onblur="this.placeholder = "Enter your name" placeholder="Enter your name" value='.$username.' readonly>
                            </div>
                        </div>
                        <div class="col-4">
                        ...
                        <div class="col-8">
                            <div class="form-group">
                                <input class="form-control valid" name="txtPass1" id="txtPass1" type="password" onfocus="this.placeholder = """ onblur="this.placeholder = Masukan Kata Sandi" placeholder="Masukan Kata Sandi">
                            </div>
                        </div>
                        <div class="col-4">
                            <div style="text-align: right;">Kofirmasi Passowrd</div>
                        </div>
                        <div class="col-8">
                            <div class="form-group">
                                <input class="form-control" name="txtPass2" id="txtPass2" type="password" onfocus="this.placeholder = """ onblur="this.placeholder = Validasi Masukan Kata Sandi" placeholder="Validasi Masukan Kata Sandi">
                            </div>
                        </div>
                        <div class="form-group mt-3">
                            <center><button type="submit" class="button button-contactForm boxed-btn" onclick="jvSave()">Simpan</button></center>
                        </div>
                    </div>
                </form>
            </div>
        ...
        $content = '
            <div class="col-lg-8">
                <form form-group mt-3>
                    <div class="row">
                        <div class="col-12">
                            <div style="text-align: left;"><b><h4>INFO PENGGUNA</h4></b></div>
                        </div><br><br>
                        <div class="col-4">
                            <div style="text-align: right;">Username</div>
                        </div>
                        <div class="col-8">
                            <div class="form-group">
                                <input class="form-control valid" name="name" id="name" type="text"  onblur="this.placeholder = "Enter your name" placeholder="Enter your name" value='.$userid.' readonly>
                            </div>
                        </div>
                        <div class="col-4">
                            <div style="text-align: right;">Nama Pengguna</div>
                        </div>
                        <div class="col-8">
                            <div class="form-group">
                                <input class="form-control valid" name="name" id="name" type="name" onblur="this.placeholder = "Enter name address" placeholder="Email" value='.$username.' readonly>
                            </div>
                        </div>
                        <div class="col-4">
                            <div style="text-align: right;">Level</div>
                        </div>
                        <div class="col-8">
                            <div class="form-group">
                                <input class="form-control" name="subject" id="subject" type="text" onblur="this.placeholder = "Enter Subject" placeholder="Enter Subject" value='.$level.' readonly>
                            </div>
                        </div>
                    </div>
                </form>
