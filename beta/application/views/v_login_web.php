...
<div class="row">
    <div class="col-12">
        ...
        <center><h2 class="contact-title"><img src="<?=base_url()?>resources/assets/img/logo/Logo_jconnect_new.png" width='25%' height='45%'></h2></center>
    ...
    <div class="col-lg-12">
        <form class="form-contact contact_form" action="/login_web/validate_credentials" method="post" id="contactForm" novalidate="novalidate" enctype="multipart/form-data">
            ...
            <div class="col-12">
                <center><font size=3 style="color:#cccccc">Dengan melakukan akses ini kami anggap berarti Anda<br>telah membaca dan menyetujui <a href="termofuse" class="termofuse" target='_blank'>Kebijakan Penggunaan</a> dan <a href="Privacy" class="privacy" target='_blank'>Kebijakan Privasi</a> kami.</font></center>
            </div><br>
