            ...
            <div class="col-xl-3 col-lg-3 col-md-4">
                ...
                <div class="job-category-listing mb-50" id='side_myjconnect'>
                        <div class="single-listing">
                            ...
                            <div class="single-listing">
                                <a id='menu_web' href="<?php echo base_url(); ?>privacy/transfer_informasi">I. Transfer Informasi Pribadi Anda Luar Yuridiksi Lokal Anda</a>
                            </div><br>
                            <div class="single-listing">
...
<?php
    ...
    if($type==10){
?>
                                    <h3 id="toc10">&nbsp;I. Transfer Informasi Pribadi Anda Luar Yuridiksi Lokal Anda</h3>
                                    <ol class="ordered-list">
                                        <li align="justify">
                                            <p align="justify">
