...
// $optCountry = array('0'=>'--国を選ぶ--','1'=>'インドネシア','2'=>'日本');
...
$(document).ready(function(){
    ...
    $('#txtPASWD2').bind('change',function(data){
        ...
        if(pass1 != pass2){
            alert('入力したパスワードが違うので、パスワードを再入力してください');
            $('#txtPASWD2').val('');
            $('#txtPASWD2').focus();
            return;
        }
            ...
            <div class="col-xl-3 col-lg-3 col-md-4">
                ...
                <div class="job-category-listing mb-50" id='side_myjconnect'>
                        <div class="single-listing">
                            ...
                            <div class="single-listing">
                                <a id='menu_web' href="<?php echo base_url(); ?>myjconnect_client/perekrutan/<?=$idclnt?>"><i class="fa fa-book"></i>&nbsp;&nbsp;採用情報</a>
                            </div><br>
                            <div class="single-listing">
                                <a id='menu_web' href="<?php echo base_url(); ?>myjconnect_client/laporan"><i class="fa fa-file"></i>&nbsp;&nbsp;報告書</a>
                            </div><br>
                            <div class="single-listing">
