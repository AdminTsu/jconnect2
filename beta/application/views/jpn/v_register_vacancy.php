...
$optCountry = array(0=>'--国を選ぶ--',1 =>'インドネシア');
// print_r($optCountry);
$optPrvince = $this->m_master->getComboProvinceJP();
// $optPrvince = array('0'=>'-');
...
function jvSend(){
    ...
    if((!usrnam && !passwd && !comnam && !namess && !emails && !comnam && !mobile && !contry && !provnc && !cityss)){
        ...
        if(ya){
            $.post('/jpn/register/validation_c',prm,function(data){
                alert('登録成功!');
                return;
            });
        }else{
...
function jvChangeContry(idcontry){
    ...
    if(idcontry != 0){
        $.ajax({
            ...
            url: "/jpn/register/comboProvince/"+idcontry, // Isi dengan url/path file php yang dituju
...
function jvChangeProvinsi(){
    ...
    if(idprovnc != 0){
        $.ajax({
            type: "POST", // Method pengiriman data bisa dengan GET atau POST
            url: "/jpn/register/comboKota/"+idcontry+"/"+idprovnc, // Isi dengan url/path file php yang dituju
        ...
        <div class="row">
            <div class="col-lg-8">
                <form class="form-contact contact_form" action="/jpn/register/validation_c" method="post" id="contactForm" novalidate="novalidate" enctype="multipart/form-data">
                    ...
                    <?php echo $this->session->flashdata('msg_usrnam'); ?>
                        <div class="col-sm-6">
                    ...
                    <?php echo $this->session->flashdata('msg_comnam'); ?>
                        <div class="col-sm-6">
                    ...
                    <?php echo $this->session->flashdata('msg_telpon'); ?>
                        <div class="col-sm-6">
                    ...
                    <?php echo $this->session->flashdata('msg_mobile'); ?>
                        <div class="col-sm-12">
                    ...
                    <?php echo $this->session->flashdata('msg_addres'); ?>
                        <div class="col-sm-6">
                    ...
                    <?php echo $this->session->flashdata('msg_contry'); ?>

                        <div class="col-sm-6" id='kota'>
                            <div class="form-group" id='kota2'><?=$require?>都市</div>
                        </div>
                    <?php echo $this->session->flashdata('msg_provnc'); ?>
