...
$optJOBPOS = array(
    '0'=>'何れも &emsp;&emsp;&emsp;&emsp;&emsp;',
    '1'=>'CEO/GM/ディレクター/シニアマネージャー &emsp;&emsp;&emsp;&emsp;&nbsp;',
    '2'=>'マネージャー/アシスタントマネージャー &emsp;&emsp;&emsp;&emsp;&nbsp;',
    '3'=>'スタッフ（非マナジメン、非スーパーバイザー）',
    '4'=>'非業務執行取締役 &emsp;&emsp;'
);
$optJENISS = array(
    '0'=>'何れも &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;',
    '1'=>'契約 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;',
    ...
    function jvCekLoginDetail(){
        ...
        if(user == 0 || user == '' || user == null){
            // $("#contactForm").submit(function (e) {
                alert('申し訳ございませんが、詳細を表示するには、既にアクセス権をお持ちの場合はログインし、登録し、アカウントを有効にしてください!');
                return;
            // });
        }
    }
                ...
                <div class="job-category-listing mb-50">    
                    <form enctype="multipart/form-data" id='form-submit' method='post' action="<?= base_url() ?>jpn/Find_jobs/search/">
                        <div class="single-listing">
                            ...
                            <div class="single-listing">
                                <input type="text" class="form-control w-100" placeholder="専門分野" name="txtSPSLIZ" id="txtSPSLIZ" value="<?=$spsliz?>">
                            </div>
                            <br>

                            <div class="single-listing"><h5>所在地</h5></div>
                            <div class="single-listing">
                                <input type="text" class="form-control w-100" placeholder="所在地" name="txtLOCKSI" id="txtLOCKSI" value="<?=$lokasi?>">
                            </div>
                            <br>

                            <div class="single-listing"><h5>ポジション</h5></div>
                            <div class="single-listing">
                                ...
                                <p><input type="checkbox" name="chkJOBPOS1" id="chkJOBPOS1" value="1" onclick="cb_checked('chkJOBPOS1')" <?=$chk1?> > CEO/GM/取締役/シニアマネージャー</p>
                                <p><input type="checkbox" name="chkJOBPOS2" id="chkJOBPOS2" value="2" onclick="cb_checked('chkJOBPOS2')" <?=$chk2?> > マネージャー/アシスタントマネージャー</p>
                                <p><input type="checkbox" name="chkJOBPOS3" id="chkJOBPOS3" value="3" onclick="cb_checked('chkJOBPOS3')" <?=$chk3?> > スタッフ（非マナジメン、非スーパーバイザー）</p>
                                <p><input type="checkbox" name="chkJOBPOS4" id="chkJOBPOS4" value="4" onclick="cb_checked('chkJOBPOS4')" <?=$chk4?> > 非業務執行取締役</p>
                            </div>
                            <!-- <br><br><br> -->
                            ...
                            <div class="single-listing" id=gaji><h5>給与の範囲</h5></div>
                            <div class="single-listing" id=gaji2>
                                <input align="right" type="number" placeholder="最小" name="txtSALMIN" id="txtSALMIN" value="<?=$salmin?>" style="width:45%"> -
                                <input align="right" type="number" placeholder="マックス" name="txtSALMAX" id="txtSALMAX" value="<?=$salmax?>" style="width:45%">
                            ...
                            <div class="single-listing">
                                <input type="text" class="form-control w-100" placeholder="キーワード" name="txtKEYWRD" id="txtKEYWRD" value="<?=$keywrd?>">
                            </div>

                            <div class="form-group mt-3">
                                <center>
                                    <button href="#" type="submit" id=submit class="genric-btn primary small" onclick='jvSubmit();'>検索</button>
                                    <input type="button" data-command="reset" name="reset" id="reset" value="リセット" onclick='jvReset();' class="genric-btn primary small">
                                </center>
                            </div>
            ...
            <div class="col-xl-9 col-lg-9 col-md-8">
                ...
                <section class="featured-job-area">
                    <div class="container">
                        ...
                        <div id="finalResult">
                            <div class="single-listing"><h5><b><u>ジョブリスト</u></b></h5></div>
                            <?php
                                if($jml > 0){
