                ...
                echo "
                    <tr style='border: 1px solid #bbb;'>
                        ...
                        <td style='text-align:center;border: 1px solid #bbb;'>
                            <a id='menu_web' class='genric-btn primary small' href=".base_url()."myjconnect_client/lowongan_edit/".$idents."/".$comidn."><i class='fa fa-edit'></i></a>
                        </td>
                        <td style='text-align:center;border: 1px solid #bbb;'>
                            <a id='menu_web' class='genric-btn danger small' href=".base_url()."myjconnect_client/lowongan_hapus/".$idents."/".$comidn."><i class='fa fa-times'></i></a>
                        </td>
                    </tr>
                ";
                $i++;
        ...
        if($jenis == 'edit' || $jenis == 'add'){
            if($jenis == 'add'){
                ...
                foreach($data_job as $row){
                    ...
                    $expdat = isset($row['JOB_EXPDAT']) ? $row['JOB_EXPDAT'] : NULL;
                    $jeniss = isset($row['JOB_DRTION']) ? $row['JOB_DRTION'] : NULL;
                    $jobpos = isset($row['JOB_PSTION']) ? $row['JOB_PSTION'] : NULL;
                    $status = isset($row['JOB_STATUS']) ? $row['JOB_STATUS'] : NULL;
...
<!-- -------------------------------------------------------  edit lowongan --------------------------------------------------------------- -->
            ...
            <form action="/myjconnect_client/lowongan_simpan/<?=$comidn?>" method="post" id="contactForm" novalidate="novalidate" enctype="multipart/form-data"> 
                <table class='table1'>
                    ...
                    <input type='hidden' name='cmbCOMPNY' id='cmbCOMPNY' value='<?=$comidn?>' placeholder="cmbCOMPNY">
                    <tr>
                        <td>
                            <table class='table2'>
                                <tr>
                                ...
                                <tr>
                                    <td>Posisi</td>
                                    <td>
                                        <select style='width: 500px;text-align: left;' class="form-control" name="cmbJOBPOS" id="cmbJOBPOS" onchange="jvChangeContry(this.value)" required>
                                            <?php
