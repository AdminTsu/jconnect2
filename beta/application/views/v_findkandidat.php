...
$optJOBPOS = array(
    ...
    '1'=>'Senior Manajer &emsp;&emsp;&emsp;',
...
<script>
    ...
    function jvSubmit(){
        ...
        if($('#txtKEYWRD').val() == '' && $('#txtLOCKSI').val() == '' && $('#txtSPSLIZ').val() == '' && $('#cmbJOBPOS').val() == 0 && $('#cmbTYPJOB').val() == 0 && $('#txtSALMIN').val() == 0 && $('#txtSALMAX').val() == 0){
            ...
            $.post('/Find_kandidat/search/',prm,function(data){
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-3 col-md-4">
                ...
                <!-- method='post' action="<?= base_url() ?>dashboard/Find_kandidat"  -->
                <div class="job-category-listing mb-50">    
                    <form enctype="multipart/form-data" id='form-submit' method='post' action="<?= base_url() ?>Find_kandidat/search/">
            ...
            <div class="col-xl-9 col-lg-9 col-md-8">
                ...
                <section class="featured-job-area">
                    <div class="container">
                        ...
                        <div id="finalResult">
                            <div class="single-listing"><h5><b><u>Daftar Kandidat</u></b></h5></div>
                            <?php
                                if($jml > 0){
                                    $this->load->view('v_list_kandidat', array('data'=>$isi)); // Load file view.php dan kirim data siswanya
                                }else{
                                    $this->load->view('v_list_kandidat_empty');
                                }
                            ?>
                        </div>
