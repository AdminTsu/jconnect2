            ...
            <tr>
                <td><br>
                    ...
                    <fieldset class="ignielMultiTab">
                        ...
                        <label for="tab2">Belum Diproses</label>
                            ...
                            <div class="tab1">
                                ...
                                <?php
                                    ...
                                    foreach($column as $row){
                                        ...
                                        if($STSNYA == 0){
                                            $tombol = '
                                                <td><a id="tbl-tdksesuai" href="/myjconnect_client/update_status/'.$JOBSID.'/4" alt="Tidak Sesuai">Tidak Sesuai</a></td>
                                                <td><a id="tbl-wawancara" href="/myjconnect_client/update_status/'.$JOBSID.'/2" alt="Wawancara">Wawancara</a></td>
                                                <td><a id="tbl-terpilih" href="/myjconnect_client/update_status/'.$JOBSID.'/3" alt="Terpilih">&nbsp;&nbsp;&nbsp;Terpilih&nbsp;&nbsp;&nbsp;</a></td>
                                            ';
                                        }elseif($STSNYA == 1){
                                            $tombol = '
                                                <td><a id="tbl-tdksesuai" href="/myjconnect_client/update_status/'.$JOBSID.'/4" alt="Tidak Sesuai">Tidak Sesuai</a></td>
